...
## 🔗 Backend
Este proyecto funciona con un repositorio en el frontend https://github.com/sandrablanco/front-scape.git y otro repositorio backend https://github.com/sandrablanco/back-scape.git desarrollado en Node.js. El frontend se comunica con el backend mediante una API REST, donde los endpoints principales son:
- POST /login
- POST /register
